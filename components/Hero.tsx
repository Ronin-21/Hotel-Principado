  ...
  return (
    ...
    >
      <div className="relative z-10 text-center text-white max-w-5xl mx-auto px-4 text-shadow-md text-shadow-dark/50">
        <h1 className="text-5xl md:text-8xl mb-6 font-semibold font-hero">
          Tu escapada ideal comienza aquí
        </h1>
        <h2 className="text-xl md:text-3xl max-w-3xl mx-auto leading-relaxed italic font-secondary text-primary font-semibold">
